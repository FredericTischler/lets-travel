 ...
 * startup (see ConfigFailFastTest; the Compose-style {@code :?msg} form is NOT
 * fail-fast in Spring) when a variable is absent (throws {@link IllegalArgumentException} with a
