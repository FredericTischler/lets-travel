...
/**
 * Thrown by {@code TokenValidationService} ({@code requireAnyRole}/
 * {@code requireManagerOrAdmin}) whenever a protected endpoint cannot
 * validate the {@code Authorization}
